...
println("Hello " + name + ", you are " + age.description + " years old!")
...
var randomNumber:UInt32 = arc4random_uniform(100) + 1

func sumOf100Nums () -> UInt32 {
    var total:UInt32 = 0
    for (var i = 0; i < 100; i++) {
        total += randomNumber
    }
