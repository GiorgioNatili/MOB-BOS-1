...
class animalFarmList: UITableViewController {
    
    private var animals = ["Pengin","Dolphin","Giraffe"]
    ...
    // MARK: Table View Output
    
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("animalName", forIndexPath: indexPath) as! animalNameCell
